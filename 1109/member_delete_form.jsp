...
<head>
    ...
    <style>
        ...
        /* --- 회원 탈퇴 폼을 위한 스타일 추가 --- */
        /* (member_update_form.jsp에서 가져온 스타일과 유사) */
        .delete-form table {
            width: 100%;
    ...
    <script>
        ...
        function validateDeleteForm() {
            ...
            if (currentPw.trim() === "") {
                ...
                return false; // 폼 제출(action) 중단
            }

            // 2. (요청사항) 탈퇴 확인창 띄우기
            var isConfirmed = confirm("정말 탈퇴하시겠습니까?\n모든 정보가 영구적으로 삭제되며 복구할 수 없습니다.");
            
            // 사용자가 '취소'를 누르면 false를 반환하여 폼 제출 중단
            if (isConfirmed == false) {
                return false;
            }

            // '확인'을 누르면 true를 반환하여 폼 제출(action) 실행
            return true; 
        }
        // --- [여기까지 추가] ---
    </script>
    ...
    <footer>
		...
		<div style="display: flex; gap: 40px;">
    		...
    		<div class="footer-section">
                ...
                <%
                    String isAdminFooter = (String) session.getAttribute("isAdmin"); // 풋터용 변수
