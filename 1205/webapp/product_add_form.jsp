...
<head>
    ...
    <style>
        ...
        .address-row div { display: flex; }
        .address-row input[name="trade_location_addr"] { flex-grow: 1; }
        .zipcode-btn { padding: 10px 15px; background-color: #a0a0a0; color: white; border: none; border-radius: 4px; font-size: 14px; cursor: pointer; margin-left: 10px; flex-shrink: 0; }
...
<body>
    ...
    <div class="mypage-wrapper">
        ...
        <main class="mypage-content">
            <h2>상품 등록</h2>
            <form class="product-form" action="product" method="post" enctype="multipart/form-data">
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            <th>직거래 유무</th>
                            <td class="shipping-option">
                                <input type="radio" name="is_direct_trade" value="false" id="trade_no" checked>
                                <label for="trade_no">직거래 불가능 (X)</label>
                                <input type="radio" name="is_direct_trade" value="true" id="trade_yes">
                                <label for="trade_yes">직거래 가능 (O)</label>
                            </td>
                        </tr>
