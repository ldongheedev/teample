...
<head>
    ...
    <style>
        ...
        #toast-message {
            ...
            font-size: 15px;
            opacity: 0;
            transition: visibility 0.5s, opacity 0.5s, bottom 0.5s ease-in-out;
        }
        #toast-message.show {
            visibility: visible;
            opacity: 1;
    ...
    <script>
        ...
        function deleteProduct(productId) {
            if (confirm("이 상품을 정말 삭제하시겠습니까?\n삭제된 데이터는 복구할 수 없습니다.")) {
                ...
                form.setAttribute("action", "product_delete_action.jsp");
        ...
        window.onload = function() {
            ...
            if (toastEl && toastEl.innerText.length > 0) {
...
<body>
    <%
        ...
        if (toastMessage != null) {
            out.println("<div id='toast-message'>" + toastMessage + "</div>");
                        ...
                        <div class="product-list-item">
                           ...
                           <div class="info">
                                <div class="name">
                                 ...
                                 <div class="price">가격: <%= formatter.format(pPrice) %>원</div>
                           </div>
                            
                      
                            <div class="buttons">
                                <a href="product_edit.jsp?product_id=<%= pId %>" class="edit-btn">수정</a>
                                <button type="button" class="delete-btn" onclick="deleteProduct(<%= pId %>)">삭제</button>
                            </div>
                         </div>
                <%
                        }
...
i = 0; i < 4; i++) { %>
    ...
    <footer>
        <div class="footer-section">
            <img 
            src="<%= request.getContextPath() %>/images/logo2.png" style="height: 80px; width: 200px; float: left;"
            />
            <p>(주) 중고모아 |
            대표 김령균</p>
