...
<head>
    ...
    <style>
        ...
        .accordion-content .a-icon {
            ...
            font-size: 18px;
            margin-right: 15px;
            /* 아이콘이 텍스트와 함께 상단 정렬되도록 */
            float: left; 
        }
        
        /* ✨ [수정] pre-wrap 적용: 소스코드 공백 없이 내용의 줄바꿈만 반영 */
        .accordion-content .answer-text {
            padding-left: 33px; /* 아이콘 공간 확보 */
            line-height: 1.7;
            white-space: pre-wrap; /* 사용자가 입력한 줄바꿈 보존 */
                ...
                <% for (Map<String, String> item : faqList) { %>
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            ...
                            <div class="answer-text"><%= item.get("answer") %></div>
                        </div>
                    </div>
                <% } %>
            <% } %>
